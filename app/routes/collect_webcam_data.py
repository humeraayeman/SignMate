...
def extract_features(frame):
    ...
    # Keep the same hand ordering used
...
if not camera.isOpened():
    ...
    print("Check that your camera is not being used")
    print("by another application.")
    exit()
...
print()
print("IMPORTANT:")
print("• Make the sign clearly.")
print("• Keep your hand inside the camera view.")
print("• Slightly change the position/angle between samples.")
print("• Do NOT move extremely fast.")
print()
print("For each letter:")
print("  Press the corresponding letter key.")
print("  The program will automatically capture")
print(f"  {SAMPLES_PER_LETTER} samples.")
print()
...
try:
    ...
    for letter in LETTERS:
        ...
        print(
            f"Press [{letter}] when your hand is ready."
        )
        print("-" * 60)
...
print()
print(
    "Next step: train the live webcam classifier."
)
print("=" * 60)